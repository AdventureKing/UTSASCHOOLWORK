...
/**
 * Created by Jinbir on 8/1/2015.
 */
public class myEventsAdapter  extends ArrayAdapter<gEventObject> {
    ...
    public myEventsAdapter(Context context, int resource, ArrayList<gEventObject> eventObjects) {
