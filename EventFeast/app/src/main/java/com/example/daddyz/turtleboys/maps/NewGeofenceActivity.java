...
public class NewGeofenceActivity extends FragmentActivity implements OnCameraChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeofenceCoordinates.add(new LatLng(29.435474, -98.481296));
