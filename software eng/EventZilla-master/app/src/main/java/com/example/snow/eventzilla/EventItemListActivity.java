 ...
 * {@link EventItemListFragment} and the item details
 * (if present) is a {@link EventItemDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link EventItemListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class EventItemListActivity extends FragmentActivity
        implements EventItemListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link EventItemListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(EventItemDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(EventItemDetailFragment.ARG_ITEM_ID, id);
